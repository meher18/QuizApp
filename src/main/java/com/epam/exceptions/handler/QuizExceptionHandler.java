...
public class QuizExceptionHandler {
	...
	public ResponseEntity<ExceptionResponse> handleException(QuizNotFound exception, WebRequest request) {
	...
	@ExceptionHandler(InValidQuestionDeletion.class)
	public ResponseEntity<ExceptionResponse> handleException(InValidQuestionDeletion exception, WebRequest request) {
		ExceptionResponse exceptionResponse = new ExceptionResponse();
		exceptionResponse.setTimeStamp(new Date().toString());
		exceptionResponse.setStatus(HttpStatus.BAD_REQUEST.name());
		exceptionResponse.setErrors(exception.getMessage());
