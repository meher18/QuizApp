...
<title>Quiz App | Quiz Module</title>
...
<nav class="navbar navbar-dark bg-dark">
			<a class="navbar-brand" href="/">
		  	...
		  	<h5 class = "text-center text-light">Admin / Quiz Module</h5>
		  	<div>
				<nav class="nav nav-pills nav-fill">
		   	 		<a class=" nav-item nav-link" href="adminDashboard">Home</a>
		   	 		<a class=" nav-item nav-link active" href="quizModule">Quiz Module</a>
...
<div class="card-columns mx-auto">
		...
		<div class="card">
			<div class="card-body">
				<a href="viewQuizzes"> View All Quiz's</a>
			</div>
		</div>
	</div>
