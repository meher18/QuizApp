...
public class AdminControllerTest {
	...
	void signInValidAdmin() throws Exception{
		...
		when(adminService.checkValidity(any())).thenReturn(true); 
		mockMvc.perform(get("/signInAdmin")
				.param("name", admin.getName())
				.param("pass", admin.getPass()))
	...
	void signInInValidAdmin() throws Exception{
		...
		when(adminService.checkValidity(any())).thenReturn(false); 
		mockMvc.perform(get("/signInAdmin")
				.param("name", admin.getName())
				.param("pass", admin.getPass()))
	...
	void logoutAdmin() throws Exception{
		...
		mockMvc.perform(get("/adminLogout")
				.param("name", admin.getName())
				.param("pass", admin.getPass())
				.sessionAttr("adminUserName", admin.getName()))
